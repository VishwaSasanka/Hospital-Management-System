...
<nav id="header-nav" class="navbar navbar-default">
        ...
        <div class="text-center" id="collapsable-nav" class="collapse navbar-collapse">
          <ul id="nav-list" class="nav navbar-nav navbar-right">
                ...
                <li><a href="{{route('recPage')}}" style="color: blue;">Logout</a></li>
          </ul>
        </div>
    </nav>
  </div>
...
<div class="container">
	...
	<div class="col-md-6">
		<div class="col-md-12">
			...
			<button onclick="document.getElementById('patid').value='';" class="btn" data-toggle="modal" data-target="#exampleModalCenter3">Send A Message</button>
			<table>
				<thead>
					<tr>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
			<form method="POST" action="/recreply" >
			@csrf
                <div class="">
	...
	<div class="modal fade" id="exampleModalCenter3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
			<form method="POST" action="recsend" >
			@csrf
                <div class="">
                   <input id="msg" type="text" name="msg" required="required" placeholder="Type message here...."> <br>
				   Patient Id:
				   <select name="patid" id="">
				   @if(count($p) > 0)
                    @foreach($p as $se)
					<option value="{{$se->Pat_id }}">{{$se->Pat_id }}</option>
                           
                           
						@endforeach
						@else
						<tr>
							<td colspan="7"><h3 style=" color:black;text-align: center;">No Patients</h3></td>
						</tr>
						@endif
